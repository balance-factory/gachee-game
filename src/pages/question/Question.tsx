...
const Question: React.FC = () => {
    ...
    const [situationAndQuestion, setSituationAndQuestion] = useState<Interface.Question[]>();
    ...
    useEffect(() => {
        if (situationAndQuestion && situationAndQuestion.length > 0 && questionId) {
            const indexNumber = situationAndQuestion.findIndex((s) => s.questionId === Number(questionId));
            ...
            <ContentLayout>
                ...
                <>
                    {lastPath && situationAndQuestion && (
                        <>
                            <SituationImage src={situationAndQuestion[situationOffset].situationImage} />
